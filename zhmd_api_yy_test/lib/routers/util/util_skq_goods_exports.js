    ...
    result.map(item =>{
        ...
        if(goods_name){
            ...
            if(map.has(goods_name)){
                ...
                if(goods_brand !== undefined && goods_brand !== null && goods_brand !== "undefined") attr_value["goods_brand"] = goods_brand;
        ...
        if(find_goods && Object.keys(find_goods).length >0) { // 存在该商品
            ...
            for(let spec_item of item_values.goods_spec_obj_arr){
                ...
                if(!find_goods_spec || Object.keys(find_goods_spec).length <=0){ // 新建
                    ...
                    const  spec_item = {"spec1_name":"颜色","spec1_value":spec_value,"spec2_name":"","spec2_value":"","spec3_name":"",spec_pic};
                    if(color){
                    ...
                    let doc = {'$set':{'data.spec_pic': spec_pic}};

                    if(color){

                        doc["data.color"] = color;
                    }
            ...
            await Promise.map(item_values.goods_spec_obj_arr,async spec_item =>{
                ...
                // 创建规格
                const  spec_item_data = {"spec1_name":"颜色","spec1_value":spec_value,"spec2_name":"","spec2_value":"","spec3_name":"","spec3_value":"",spec_pic};
